...
<head> 
	...
	$(function(){
		if("${message}"){
			parent.$("#userName").text("${session_user.name}");
			$.messager.show({title:'提示信息',msg:"${message}",showType:'show'});
		}
	      ...
	      <div class="row info-content">
		 	<form id="updateSelfForm" class="form-horizontal" method="post" action="${ctx }/identity/user/updateSelf.jspx"  style="margin-top: 20px;">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						 <button type="button" id="btn_submit"  class="btn btn-info"><span class="glyphicon glyphicon-edit"></span>提交修改</button>
					</div>
				</div>
		 	 </form>
		    </div>
